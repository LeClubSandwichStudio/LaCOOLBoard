...
\begin{DoxyCode}
17                                                              \{
18   \hyperlink{class_wi_fi_manager_parameter_a2b468d83df6e0714c18a38f09e7996ed}{\_id} = NULL;
19   \hyperlink{class_wi_fi_manager_parameter_aceb6003c96280319fb19f83ebaf3034b}{\_placeholder} = NULL;
20   \hyperlink{class_wi_fi_manager_parameter_a30ca2df3654651a1b5320261a061b774}{\_length} = 0;
21   \hyperlink{class_wi_fi_manager_parameter_a80c6492e74603e4df46219b23580ecb6}{\_value} = NULL;
22 
23   \hyperlink{class_wi_fi_manager_parameter_a3823cb117da1a75860cc3e81b0c6f80d}{\_customHTML} = custom;
24 \}
\end{DoxyCode}
...
26                                                                                                            
                   \{
27   \hyperlink{class_wi_fi_manager_parameter_a137b764027d3851a428f3ab185a5660f}{init}(\textcolor{keywordtype}{id}, placeholder, defaultValue, length, \textcolor{stringliteral}{""});
28 \}
\end{DoxyCode}
...
30                                                                                                            
                                       \{
31   \hyperlink{class_wi_fi_manager_parameter_a137b764027d3851a428f3ab185a5660f}{init}(\textcolor{keywordtype}{id}, placeholder, defaultValue, length, custom);
32 \}
\end{DoxyCode}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\begin{DoxyCode}
61                                                 \{
62   \textcolor{keywordflow}{return} \hyperlink{class_wi_fi_manager_parameter_a3823cb117da1a75860cc3e81b0c6f80d}{\_customHTML};
63 \}
\end{DoxyCode}
...
\begin{DoxyCode}
52                                         \{
53   \textcolor{keywordflow}{return} \hyperlink{class_wi_fi_manager_parameter_a2b468d83df6e0714c18a38f09e7996ed}{\_id};
54 \}
\end{DoxyCode}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\begin{DoxyCode}
55                                                  \{
56   \textcolor{keywordflow}{return} \hyperlink{class_wi_fi_manager_parameter_aceb6003c96280319fb19f83ebaf3034b}{\_placeholder};
57 \}
\end{DoxyCode}
...
\begin{DoxyCode}
49                                            \{
50   \textcolor{keywordflow}{return} \hyperlink{class_wi_fi_manager_parameter_a80c6492e74603e4df46219b23580ecb6}{\_value};
51 \}
\end{DoxyCode}
...
\begin{DoxyCode}
58                                          \{
59   \textcolor{keywordflow}{return} \hyperlink{class_wi_fi_manager_parameter_a30ca2df3654651a1b5320261a061b774}{\_length};
60 \}
\end{DoxyCode}
...
34                                                                                                            
                            \{
35   \hyperlink{class_wi_fi_manager_parameter_a2b468d83df6e0714c18a38f09e7996ed}{\_id} = id;
36   \hyperlink{class_wi_fi_manager_parameter_aceb6003c96280319fb19f83ebaf3034b}{\_placeholder} = placeholder;
37   \hyperlink{class_wi_fi_manager_parameter_a30ca2df3654651a1b5320261a061b774}{\_length} = length;
38   \hyperlink{class_wi_fi_manager_parameter_a80c6492e74603e4df46219b23580ecb6}{\_value} = \textcolor{keyword}{new} \textcolor{keywordtype}{char}[length + 1];
39   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < length; i++) \{
40     \hyperlink{class_wi_fi_manager_parameter_a80c6492e74603e4df46219b23580ecb6}{\_value}[i] = 0;
41   \}
42   \textcolor{keywordflow}{if} (defaultValue != NULL) \{
43     strncpy(\hyperlink{class_wi_fi_manager_parameter_a80c6492e74603e4df46219b23580ecb6}{\_value}, defaultValue, length);
44   \}
45 
46   \hyperlink{class_wi_fi_manager_parameter_a3823cb117da1a75860cc3e81b0c6f80d}{\_customHTML} = custom;
47 \}
\end{DoxyCode}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
