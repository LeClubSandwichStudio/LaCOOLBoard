...
Definition at line 330 of file External\+Sensor.\+h.
...
Definition at line 337 of file External\+Sensor.\+h.


\begin{DoxyCode}
338     \{
339         
340 \textcolor{preprocessor}{    #if DEBUGExternal == 1 }
341 
342         Serial.println( \textcolor{stringliteral}{"ExternalSensor <DallasTemperature> constructor"} );
343         Serial.println();
344     
345 \textcolor{preprocessor}{    #endif}
346         \hyperlink{class_external_sensor_3_01_dallas_temperature_01_4_adb6ba4fcdedef95ad8f6b0c9b6c0f9d1}{sensor}=DallasTemperature(\hyperlink{_external_sensors_8cpp_af39fa3dad1ba161b384c0b26b8145e65}{oneWire});
347     \}
\end{DoxyCode}
...
Definition at line 355 of file External\+Sensor.\+h.


\begin{DoxyCode}
356     \{
357     
358 \textcolor{preprocessor}{    #if DEBUGExternal == 1 }
359 
360         Serial.println( \textcolor{stringliteral}{"ExternalSensor <DallasTemperature> begin()"} );
361         Serial.println();
362     
363 \textcolor{preprocessor}{    #endif}
364 
365         \hyperlink{class_external_sensor_3_01_dallas_temperature_01_4_adb6ba4fcdedef95ad8f6b0c9b6c0f9d1}{sensor}.begin(); 
366         delay(5);
367         \hyperlink{class_external_sensor_3_01_dallas_temperature_01_4_adb6ba4fcdedef95ad8f6b0c9b6c0f9d1}{sensor}.getAddress(this->\hyperlink{class_external_sensor_3_01_dallas_temperature_01_4_a7d9e9d2893e453638fcf440e5d8d9082}{dallasAddress}, 0);   
...
Definition at line 376 of file External\+Sensor.\+h.


\begin{DoxyCode}
377     \{
378 
379         \hyperlink{class_external_sensor_3_01_dallas_temperature_01_4_adb6ba4fcdedef95ad8f6b0c9b6c0f9d1}{sensor}.requestTemperatures(); \textcolor{comment}{// Send the command to get temperatures}
380         \textcolor{keywordtype}{float} result=(float) \hyperlink{class_external_sensor_3_01_dallas_temperature_01_4_adb6ba4fcdedef95ad8f6b0c9b6c0f9d1}{sensor}.getTempCByIndex(0);
381 \textcolor{preprocessor}{    #if DEBUGExternal == 1 }
382 
383         Serial.println( \textcolor{stringliteral}{"ExternalSensor <DallasTemperature> read()"} );
384         Serial.println();
385 
386         Serial.print(\textcolor{stringliteral}{"Requesting temperature..."});
387 
388         Serial.print( \textcolor{stringliteral}{"temperature : "});
389         Serial.print( result );
390         Serial.print( \textcolor{stringliteral}{"°C"} );
391         Serial.println();
392     
...
Definition at line 402 of file External\+Sensor.\+h.
