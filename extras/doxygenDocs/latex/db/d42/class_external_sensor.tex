...
Definition at line 136 of file External\+Sensor.\+h.
...
Definition at line 142 of file External\+Sensor.\+h.


\begin{DoxyCode}
143     \{
144     
145 \textcolor{preprocessor}{    #if DEBUGExternal == 1 }
146 
147         Serial.println( \textcolor{stringliteral}{"ExternalSensor <Generic> Constructor"} );
148         Serial.println();
149     
150 \textcolor{preprocessor}{    #endif}
151 
152         \hyperlink{class_external_sensor_a6e1f518119abe08c14b498ce24a7e1b3}{sensor}();
153     \}
\end{DoxyCode}
...
Definition at line 160 of file External\+Sensor.\+h.


\begin{DoxyCode}
161     \{
162     
163 \textcolor{preprocessor}{    #if DEBUGExternal == 1 }
164 
165         Serial.println( \textcolor{stringliteral}{"ExternalSensor <Generic> begin()"} );
166         Serial.println();
167     
168 \textcolor{preprocessor}{    #endif}
169 
170         \textcolor{keywordflow}{return}(\hyperlink{class_external_sensor_a6e1f518119abe08c14b498ce24a7e1b3}{sensor}.begin() );  
171     \}
\end{DoxyCode}
...
177     \{
178     
179 \textcolor{preprocessor}{    #if DEBUGExternal == 1 }
180 
181         Serial.println( \textcolor{stringliteral}{"ExternalSensor <Generic> read() "} );
182         Serial.println();
183         
184 \textcolor{preprocessor}{    #endif}
185 
186         \textcolor{keywordflow}{return}(\hyperlink{class_external_sensor_a6e1f518119abe08c14b498ce24a7e1b3}{sensor}.read());
187     \}
\end{DoxyCode}
...
Definition at line 193 of file External\+Sensor.\+h.
