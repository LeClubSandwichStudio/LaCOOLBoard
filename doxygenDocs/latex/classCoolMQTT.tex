...
447         
448             Serial.println(\textcolor{stringliteral}{"configuration json is "});
449             json.printTo(Serial);
450             Serial.println();
451 
452 \textcolor{preprocessor}{        #endif}
453 
454             \textcolor{keywordflow}{if}(json[\textcolor{stringliteral}{"mqttServer"}].success() )
455             \{           
456                 \textcolor{keyword}{const} \textcolor{keywordtype}{char}* tempmqttServer = json[\textcolor{stringliteral}{"mqttServer"}]; 
457                 \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i =0;i< 50 ;i++)
458                 \{
459                     \hyperlink{classCoolMQTT_ab8bb951f87ddbf92db74c2ad16a3e53e}{mqttServer}[i]=tempmqttServer[i];
460                 \}
461             \}
462             \textcolor{keywordflow}{else}
463             \{
464                 \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i =0;i< 50 ;i++)
465                 \{
466                     this->\hyperlink{classCoolMQTT_ab8bb951f87ddbf92db74c2ad16a3e53e}{mqttServer}[i]=this->\hyperlink{classCoolMQTT_ab8bb951f87ddbf92db74c2ad16a3e53e}{mqttServer}[i];
467                 \}
468 
469             \}
470             json[\textcolor{stringliteral}{"mqttServer"}]=this->\hyperlink{classCoolMQTT_ab8bb951f87ddbf92db74c2ad16a3e53e}{mqttServer};
471 
472             
473             \textcolor{keywordflow}{if}(json[\textcolor{stringliteral}{"inTopic"}].success() )
474             \{
475                 \textcolor{keyword}{const} \textcolor{keywordtype}{char}* tempInTopic = json[\textcolor{stringliteral}{"inTopic"}]; 
476                 \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i =0;i< 50;i++)
477                 \{
478                     \hyperlink{classCoolMQTT_a4492f52a441e83cc5151010317fdb52d}{inTopic}[i]=tempInTopic[i];
479                 \}
480             \}
481             \textcolor{keywordflow}{else}
482             \{
483                 String tempMAC = WiFi.macAddress();
484                 tempMAC.replace(\textcolor{stringliteral}{":"},\textcolor{stringliteral}{""});
485                 snprintf(\hyperlink{classCoolMQTT_a4492f52a441e83cc5151010317fdb52d}{inTopic}, 50, \textcolor{stringliteral}{"$aws/things/%s/shadow/update/delta"}, tempMAC.c\_str());    
486             
487 \textcolor{preprocessor}{            #if DEBUG == 1              }
488                 
489                 Serial.print(\textcolor{stringliteral}{"Set Incomming MQTT Channel to : "});
490                 Serial.println(\hyperlink{classCoolMQTT_a4492f52a441e83cc5151010317fdb52d}{inTopic});
491             
492 \textcolor{preprocessor}{            #endif  }
493 
494             \}
495             json[\textcolor{stringliteral}{"inTopic"}]=this->\hyperlink{classCoolMQTT_a4492f52a441e83cc5151010317fdb52d}{inTopic};
496             
497             
498             \textcolor{keywordflow}{if}(json[\textcolor{stringliteral}{"outTopic"}].success() )
499             \{
500                 \textcolor{keyword}{const} \textcolor{keywordtype}{char}* tempOutTopic = json[\textcolor{stringliteral}{"outTopic"}]; 
501                 \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i =0;i<50;i++)
502                 \{
503                     \hyperlink{classCoolMQTT_a109c786a17b463f9eeba046194279522}{outTopic}[i]=tempOutTopic[i];
504                 \}
505             \}
506             \textcolor{keywordflow}{else}
507             \{
508                 String tempMAC = WiFi.macAddress();
509                 tempMAC.replace(\textcolor{stringliteral}{":"},\textcolor{stringliteral}{""});
510                 snprintf(\hyperlink{classCoolMQTT_a109c786a17b463f9eeba046194279522}{outTopic}, 50, \textcolor{stringliteral}{"$aws/things/%s/shadow/update"}, tempMAC.c\_str());
511             
512 \textcolor{preprocessor}{            #if DEBUG == 1 }
513 
514                 Serial.print(\textcolor{stringliteral}{"Set Outgoing MQTT Channel to : "});
515                 Serial.println(\hyperlink{classCoolMQTT_a109c786a17b463f9eeba046194279522}{outTopic});
516             
517 \textcolor{preprocessor}{            #endif}
518 
519             \}
520             json[\textcolor{stringliteral}{"outTopic"}]=this->\hyperlink{classCoolMQTT_a109c786a17b463f9eeba046194279522}{outTopic};
521         
522             
523             \textcolor{keywordflow}{if}(json[\textcolor{stringliteral}{"user"}].success() )
524             \{               
525                 \textcolor{keyword}{const} \textcolor{keywordtype}{char}* tempUser = json[\textcolor{stringliteral}{"user"}]; 
526                 \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i =0;i<50;i++)
527                 \{
528                     \hyperlink{classCoolMQTT_a8cd47e45d457f908d4b4390b35aaee83}{user}[i]=tempUser[i];
529                 \}
530             \}
531             \textcolor{keywordflow}{else}
532             \{
533                 \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0;i<50;i++)
534                 \{
535                     this->\hyperlink{classCoolMQTT_a8cd47e45d457f908d4b4390b35aaee83}{user}[i]=this->\hyperlink{classCoolMQTT_a8cd47e45d457f908d4b4390b35aaee83}{user}[i];
536                 \}               
537             \}
538             json[\textcolor{stringliteral}{"user"}]=this->\hyperlink{classCoolMQTT_a8cd47e45d457f908d4b4390b35aaee83}{user};
539             
540             \textcolor{keywordflow}{if}(json[\textcolor{stringliteral}{"bufferSize"}].success() )
541             \{
542                 \textcolor{keywordtype}{int} tempBufferSize = json[\textcolor{stringliteral}{"bufferSize"}]; 
543                 \hyperlink{classCoolMQTT_a7f3cf26b51d6770f216e42c5ef13ca9f}{bufferSize}=tempBufferSize;
544             \}
545             \textcolor{keywordflow}{else}
546             \{
547                 this->\hyperlink{classCoolMQTT_a7f3cf26b51d6770f216e42c5ef13ca9f}{bufferSize}=this->\hyperlink{classCoolMQTT_a7f3cf26b51d6770f216e42c5ef13ca9f}{bufferSize};
548             \}
549             json[\textcolor{stringliteral}{"bufferSize"}]=this->\hyperlink{classCoolMQTT_a7f3cf26b51d6770f216e42c5ef13ca9f}{bufferSize};
550 
551             configFile.close();
552             configFile = SPIFFS.open(\textcolor{stringliteral}{"/mqttConfig.json"}, \textcolor{stringliteral}{"w"});
553             \textcolor{keywordflow}{if}(!configFile)
554             \{
555             
556 \textcolor{preprocessor}{            #if DEBUG == 1 }
557 
558                 Serial.println(\textcolor{stringliteral}{"failed to write to /mqttConfig.json"});
559             
...
569 
570             Serial.println(\textcolor{stringliteral}{"saved configuration is :"});
