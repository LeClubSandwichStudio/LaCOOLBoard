...
Definition at line 829 of file Cool\+Board.\+cpp.
...
833 
834     Serial.println( F(\textcolor{stringliteral}{"Entering CoolBoard.getLogInterval() "}) );
835     Serial.println();
836     Serial.println( F(\textcolor{stringliteral}{"log Interval is :"}) );
837     Serial.println(\hyperlink{classCoolBoard_a4de0096d575d66b472c4c1f0111fd452}{logInterval});
838     Serial.println();
839 
840 \textcolor{preprocessor}{#endif}
841 
842     \textcolor{keywordflow}{return}(\textcolor{keyword}{this} -> \hyperlink{classCoolBoard_a4de0096d575d66b472c4c1f0111fd452}{logInterval});
843 \}
\end{DoxyCode}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
Definition at line 853 of file Cool\+Board.\+cpp.
...
857 
858     Serial.println( F(\textcolor{stringliteral}{"Entering CoolBoard.readSensors()"}) );
859     Serial.println();
860 
...
864 
865     sensorsData = \hyperlink{classCoolBoard_af102be5288bd7f7a8e59b13f86e26a00}{coolBoardSensors}.\hyperlink{classCoolBoardSensors_a91badb2539d91fda8679f2a597874c48}{read}(); \textcolor{comment}{// \{..,..,..\}}
866     
867     \textcolor{keywordflow}{if} (\hyperlink{classCoolBoard_a638b00b76aeb819ecfd4c10b8cdd7bb7}{externalSensorsActive})
868     \{
869         sensorsData += \hyperlink{classCoolBoard_a09e26264839c65873eb56af476eff6b2}{externalSensors}.\hyperlink{classExternalSensors_a53177b81eca3be89508b5511ddcd00fc}{read}(); \textcolor{comment}{// \{..,..,..\}\{..,..\}}
870 
871         sensorsData.setCharAt(sensorsData.lastIndexOf(\textcolor{charliteral}{'\}'}), \textcolor{charliteral}{','}); \textcolor{comment}{// \{..,..,..\}\{..,..,}
872         sensorsData.setCharAt(sensorsData.lastIndexOf(\textcolor{charliteral}{'\{'}), \textcolor{charliteral}{','}); \textcolor{comment}{// \{..,..,..\},..,..,}
873         sensorsData.remove(sensorsData.lastIndexOf(\textcolor{charliteral}{'\}'}), 1); \textcolor{comment}{// \{..,..,..,..,..,}
874         sensorsData.setCharAt(sensorsData.lastIndexOf(\textcolor{charliteral}{','}), \textcolor{charliteral}{'\}'}); \textcolor{comment}{// \{..,..,..,..,..\}}
875 
876     \}
877     \textcolor{keywordflow}{if} (\hyperlink{classCoolBoard_a9c3f7ac625481ee2ae802a25d97a4ae0}{ireneActive})
878     \{
879         sensorsData += \hyperlink{classCoolBoard_ad103718ce316006c4695b8eb312eaf11}{irene3000}.\hyperlink{classIrene3000_a852a170feea994ea1df01c6b245b5d9a}{read}(); \textcolor{comment}{// \{..,..,..,..,..\}\{..,..,..\}}
880 
881         sensorsData.setCharAt(sensorsData.lastIndexOf(\textcolor{charliteral}{'\}'}), \textcolor{charliteral}{','}); \textcolor{comment}{// \{..,..,..,..,..\{..,..,..,}
882         sensorsData.setCharAt(sensorsData.lastIndexOf(\textcolor{charliteral}{'\{'}), \textcolor{charliteral}{','}); \textcolor{comment}{// \{..,..,..,..,..\},..,..,..,}
883         sensorsData.remove(sensorsData.lastIndexOf(\textcolor{charliteral}{'\}'}), 1); \textcolor{comment}{// \{..,..,..,..,..,..,..,..,}
884         sensorsData.setCharAt(sensorsData.lastIndexOf(\textcolor{charliteral}{','}), \textcolor{charliteral}{'\}'}); \textcolor{comment}{// \{..,..,..,..,..,..,..,..\}}
885         
886     \}
887     
888 \textcolor{preprocessor}{#if DEBUG == 1}
889 
890     Serial.println( F(\textcolor{stringliteral}{"sensors data is "}) );
891     Serial.println(sensorsData);
892     Serial.println();
893 
894 \textcolor{preprocessor}{#endif}
895 
896     \textcolor{keywordflow}{return}(sensorsData);
897 
898 \}
\end{DoxyCode}
Here is the call graph for this function\+:
...
958 
959     Serial.println( F(\textcolor{stringliteral}{"Entering CoolBoard.sleep() "}) );
960     Serial.print( F(\textcolor{stringliteral}{"going to sleep for "}) );
961     Serial.print(interval);
962     Serial.println(F(\textcolor{stringliteral}{"ms"}) );
963     Serial.println();
964 
965 \textcolor{preprocessor}{#endif}
966 
967     ESP.deepSleep ( ( interval * 1000 ), WAKE\_RF\_DEFAULT) ;
968 \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
...
712 
713         \textcolor{keywordflow}{if} (stateDesired[\textcolor{stringliteral}{"update"}] == 1)
714         \{
...
720         
721             Serial.println( F(\textcolor{stringliteral}{"update is 1 "}) );
722             Serial.println( F(\textcolor{stringliteral}{"desired update is : "}) );            
723             Serial.println(answerDesired);
724             Serial.println(\textcolor{stringliteral}{"json size is : "});
...
730             
731             \hyperlink{classCoolBoard_a42c2586fbb13ff7f06538e9284e8538d}{fileSystem}.\hyperlink{classCoolFileSystem_a32dad79ae80182a83e2e8f52286b7c7b}{updateConfigFiles}(answerDesired, 
      \hyperlink{classCoolBoard_af2da1f85315b3d074a8b87d158094fb7}{answerJsonSize});
732 
733             \textcolor{comment}{//applying the configuration    }
734             \textcolor{keyword}{this} -> \hyperlink{classCoolBoard_a583a874c09c07e70a6eb9229fc4beddb}{config}();
735 
736             \hyperlink{classCoolBoard_af102be5288bd7f7a8e59b13f86e26a00}{coolBoardSensors}.\hyperlink{classCoolBoardSensors_a9a218895c5423375c33c08f2c56fb23a}{config}();
737 
738             \hyperlink{classCoolBoard_a50d2a6716879d64a85f3c6b44ad63275}{rtc}.\hyperlink{classCoolTime_a87c28260c1bc77091162cbcf1ee2e129}{config}();
739 
740             \hyperlink{classCoolBoard_a1b1d3c684a5baa56b08486e192fd8e97}{coolBoardLed}.\hyperlink{classCoolBoardLed_a1b60e5e30bea96c49ed62ed1bf1ffc8b}{config}();
741             
742             \hyperlink{classCoolBoard_acd88e6003606b47479ebba81e4aceeca}{wifiManager}.\hyperlink{classCoolWifi_a4eb2f6b9b09dd588964b88b6c70122c0}{config}();
743 
744             \hyperlink{classCoolBoard_a2399f44d7c23c1149a335cb3b46d90f1}{mqtt}.\hyperlink{classCoolMQTT_a9b703de4f1358f0ee7a5e8c44979c648}{config}();
745 
746             \textcolor{keywordflow}{if} (\hyperlink{classCoolBoard_a9be03a913d26e558328935ca3b59a75e}{jetpackActive})
747             \{
748                 \hyperlink{classCoolBoard_a30b1357881b01ccbec676856a91e48e9}{jetPack}.\hyperlink{classJetpack_ab065ee83e244265a2223a22f3ee4a719}{config}();
749             \}
750 
751             \textcolor{keywordflow}{if} (\hyperlink{classCoolBoard_a9c3f7ac625481ee2ae802a25d97a4ae0}{ireneActive})
752             \{
753                 \hyperlink{classCoolBoard_ad103718ce316006c4695b8eb312eaf11}{irene3000}.\hyperlink{classIrene3000_afed5c35e4b23963c157847ef27c11e9c}{config}();
754             \}
755 
756             \textcolor{keywordflow}{if} (\hyperlink{classCoolBoard_a638b00b76aeb819ecfd4c10b8cdd7bb7}{externalSensorsActive})
757             \{
758                 \hyperlink{classCoolBoard_a09e26264839c65873eb56af476eff6b2}{externalSensors}.\hyperlink{classExternalSensors_a862a4bd11346b37270d0244c2adabe5a}{config}();
759             \}
760 
761             delay(10);
762             \hyperlink{classCoolBoard_acd88e6003606b47479ebba81e4aceeca}{wifiManager}.\hyperlink{classCoolWifi_a46942fed90e475112cc10b78a32e7aaa}{begin}();
763             delay(100);
764             \hyperlink{classCoolBoard_a2399f44d7c23c1149a335cb3b46d90f1}{mqtt}.\hyperlink{classCoolMQTT_ac9248808641ebf3054ed0620ea9d0100}{begin}();
765 
766                 \textcolor{comment}{//answering the update msg:}
767             \textcolor{comment}{//reported = received configuration}
768             \textcolor{comment}{//desired=null}
769         
770             String updateAnswer;
771             String tempString;
772             
773             stateDesired.printTo(tempString);
774             updateAnswer=\textcolor{stringliteral}{"\{\(\backslash\)"state\(\backslash\)":\{\(\backslash\)"reported\(\backslash\)":"};
775             updateAnswer+=tempString;
776             updateAnswer+=\textcolor{stringliteral}{",\(\backslash\)"desired\(\backslash\)":null\}\}"};
777 
778 \textcolor{preprocessor}{        #if DEBUG == 1}
779 
780             Serial.println( F(\textcolor{stringliteral}{"preparing answer message "}) );
781             Serial.println();
782             Serial.println( F(\textcolor{stringliteral}{"updateAnswer : "}) );
783             Serial.println(updateAnswer);
784         
785 \textcolor{preprocessor}{        #endif  }
786 
787             \hyperlink{classCoolBoard_a2399f44d7c23c1149a335cb3b46d90f1}{mqtt}.\hyperlink{classCoolMQTT_ace977b3e90ab14b1199fe5c4fb0a13ec}{publish}(updateAnswer.c\_str());
788             
789             \hyperlink{classCoolBoard_a2399f44d7c23c1149a335cb3b46d90f1}{mqtt}.\hyperlink{classCoolMQTT_aa5eaae967b562b62cbcf2b8d81f6e5d5}{mqttLoop}();
790 
791             delay(10);
792             
793             \textcolor{comment}{//restart the esp}
794             ESP.restart();
795                 
796         \}
...
801 
802             Serial.println( F(\textcolor{stringliteral}{"update is not 1 "}) );
803             Serial.println();
804         
...
813 
814         Serial.println( F(\textcolor{stringliteral}{"Failed to parse update message( OR no message received )"}) );
815         Serial.println();
816     
...
Definition at line 907 of file Cool\+Board.\+cpp.
...
908 \{
909 
910 \textcolor{preprocessor}{#if DEBUG == 1}
911 
912     Serial.println( F(\textcolor{stringliteral}{"Entering CoolBoard.userData() "}) );
913     Serial.println();
914 
...
918 
919     tempMAC.replace(\textcolor{stringliteral}{":"}, \textcolor{stringliteral}{""});
920 
921     String userJson = \textcolor{stringliteral}{"\{\(\backslash\)"user\(\backslash\)":\(\backslash\)""};
922 
923     userJson += \hyperlink{classCoolBoard_a2399f44d7c23c1149a335cb3b46d90f1}{mqtt}.\hyperlink{classCoolMQTT_a373cc92fca7760d886f02d8a6e5b3f63}{getUser}();
924 
925     userJson += \textcolor{stringliteral}{"\(\backslash\)",\(\backslash\)"timestamp\(\backslash\)":\(\backslash\)""};
926 
927     userJson += \hyperlink{classCoolBoard_a50d2a6716879d64a85f3c6b44ad63275}{rtc}.\hyperlink{classCoolTime_ac4f32ee513c1328d984306645e8785a4}{getESDate}(); \textcolor{comment}{// "timestamp":"20yy-mm-ddThh:mm:ssZ"}
928 
929     userJson += \textcolor{stringliteral}{"\(\backslash\)",\(\backslash\)"mac\(\backslash\)":\(\backslash\)""};
930 
931     userJson += tempMAC;
932 
933     userJson += \textcolor{stringliteral}{"\(\backslash\)"\}"};
934 
935 \textcolor{preprocessor}{#if DEBUG == 1}
936 
937     Serial.println( F(\textcolor{stringliteral}{"userData is : "}) );
938     Serial.println(userJson);
939     Serial.println();
940 
941 \textcolor{preprocessor}{#endif  }
942     
943     \textcolor{keywordflow}{return}(userJson);
944     
945 \}
\end{DoxyCode}
Here is the call graph for this function\+:
