...
const char inTopic[] =
    "--------"; // the topic you're going to subscribe to (receive from)
const char outTopic[] =
    "-------"; // the topic you're going to publish to (send to )
...
void loop() {
  mqtt.publish(
      "hello world by CoolBoard"); // publish this message to the outTopic
  delay(1000);
